...
label startChapter4:
    ...
    snegov "{cps=45}Лучше сразу переходит к рецепту успеха сегодняшнего предприятия."
    snegov "{cps=45}Рецепт следующий: в коническую колбу пипеткой поместить 50 кубических сантиметров воды, с помощью пипетки добавить 5 миллилитров буферного раствора. Далее следует добавить индикатор эриохрома черного Т.. Жидкость должна окраситься в сиреневый цвет."
    snegov "{cps=45}Самая интересная часть - это титрование. Нужно взять вторую пипетку и начать постепенно добавлять раствор трилона Б, пока цвет жидкости не сменится на синий потеряв красные тона. Спешить не следует, раствор меняет цвет только через несколько секунд. У некоторых особо торопливых жидкость не синеет, а чернеет. Количество капель нужно подсчитать и выяснить объём затраченного раствора трилона Б. Двадцать капель - один миллилитр."
...
label addtrilon:
    ...
    if trilon < 40:
        "{cps=45}{i}Цвет явно не синий. Надо продолжать."
        jump addtrilon
        ...
        snegov "{cps=45}Знаете, Мозг - сложный и многослойный орган - по крайней мере, у большинства людей, но, видимо, не у вас. Переделывайте."
        jump colbagame
