...
label startChapter2:
    ...
    "{i}Следующая пара - теория принятия решений."
    "{i}Звучит просто."
    "{i}Все студенты голову на плечах имеют, решения принимать умеют, да и предмет скорее всего разговорный будет."
    "{i}Хотя чем проще предмет кажется, тем больше вероятность. что с ним возникнут неожиданные сложности."
