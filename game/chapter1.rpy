...
label startChapter1:
    ...
    arsentiev "{cps=25}Зовут меня Дмитрий Андреевич Арсенюшкин."
    arsentiev "{cps=25}Я тут на кафедре информатики и ИТ вроде как не последний человек."
    ...
    "{cps=25}Морально-волевые волевые возможности по поддержанию напряжённого монолога явно покинули Арсенюшкин, и он продолжил занятие в свойственном ему стиле."
