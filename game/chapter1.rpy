...
label startChapter1:
    ...
    arsenushkin "{cps=45}{i}Я смотрю к нам прибыло пополнение."
    arsenushkin "{cps=45}{i}Зовут меня Дмитрий Андреевич Арсенюшкин."
    arsenushkin "{cps=45}{i}Я тут на кафедре информатики и ИТ вроде как не последний человек."
    ...
    arsenushkin "{cps=45}{i}Сегодня у нас будет первая пара по предмету “Введение в специальность”."
    arsenushkin "{cps=45}{i}Вообще предмет будет проводится в дистанционном формате, так что напрягать вас с точки зрения передвижения не буду."
    arsenushkin "{cps=45}{i}Итак… приступим! А то я уже устал так напрягать речевой аппарат."
    
    "{cps=45}{i}Морально-волевые волевые возможности по поддержанию напряжённого монолога явно покинули Арсенюшкина, и он продолжил занятие в свойственном ему стиле."
    ...
    menu:
        arsenushkin "{cps=45}Тьюринга хоть помните?"
