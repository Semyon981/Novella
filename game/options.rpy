...
define config.name = _("Спидран по ИСиТ")
...
define gui.about = _p("""
Новелла сделана в рамках проектной деятельности московского политеха.\n
\n
Авторы:\n
Бабашкин Сергей\n
Салов Дмитрий\n
...
Красноченко Даниил\n
\n
Авторские права на иконку приложения принадлежат Freepik.
""")
...
define config.save_directory = "Novella-1698005868"
