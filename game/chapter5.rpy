...
label startChapter5:
    ...
    scene university
    with fade
    "{cps=45}{i}На сегодня всё. Можно уже домой."
    ...
    ohrannik "{cps=45}{i}Обитель наставничья, что методическим кабинетом зовётся, сразу за углом располагается."
    ...
    menu:
        "Бежать как лес.":
            if les == False:
                ...
                "{cps=45}{i}Я уже бежал как лес. Может попробовать что-то еще?"
            jump RunChoice
        ...
        "Отвести руки назад и согнуть корпус вперёд.":
            if vpered == False:
                ...
                "{cps=45}{i}Я не хочу еще раз это делать."
            jump RunChoice
