...
define audio.nornikel = "music/nornikel.wav"


label startChapter6:
    scene black
    with fade
    "{font=Gilroy-ExtraBold.otf}ГЛАВА VI “ЧИСЛЕННЫЕ МЕТОДЫ В КОМПЬЮТЕРНЫХ ВЫЧИСЛЕНИЯХ”"    
...
=======
    "{cps=45}{i}Вот и настал тот час, которого боятся все студенты ИСиТа.."
...
>>>>>>> Stashed changes
    ...
    menu:
        norin "{cps=45}Первый вопрос, что является вторым этапом процесса решения математических задач, методом математического моделирования?"
...
=======
        norin "{cps=45}Вопрос второй: Когда прекращаются итерации при при численном решении нелинейных уравнений?"
>>>>>>> Stashed changes
...
label trueAnswer1:
    norin "{cps=45}Молодец, видно, что не стал игнорировать преподавателя с самого начала занятия, ответишь ещë на один и считай зачëт у тебя в кармане."
    return